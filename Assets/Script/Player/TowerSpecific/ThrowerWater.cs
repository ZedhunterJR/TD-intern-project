...
public class ThrowerWater : TowerAttack
{
    ...
    protected override void OnAwake()
    {
        ...
        PoolManager.Instance.RegisterProjectilePool(proj, "Water_thrower_bullet", 5, projKey);

        var ex = Resources.Load<GameObject>("Prefab/explosion_object");
        var explos = Instantiate(ex);
        PoolManager.Instance.RegisterProjectilePool(explos, "Water_impact", 5, explosKey);
    }
